...
import de.dpa.metadatamapper.imaging.common.ImageMetadataWriter;
import de.dpa.metadatamapper.imaging.xmp.metadata.XMPMetadata;
import de.dpa.metadatamapper.imaging.xmp.parser.XMPMetadataFactory;
...
public class ImageMetadataOperation
{
    ...
    public de.dpa.metadatamapper.imaging.common.ImageMetadata readMetaData(final InputStream imageData) throws Exception
    {

        byte[] imageBuffer = ByteStreams.toByteArray(imageData);
        imageData.close();

        de.dpa.metadatamapper.imaging.common.ImageMetadata toReturn = new de.dpa.metadatamapper.imaging.common.ImageMetadata();
        try
        {
    ...
    private void readXMPMetadata(final byte[] imageData, final de.dpa.metadatamapper.imaging.common.ImageMetadata imageMetadata)
    ...
    protected void readIPTCAndExifMetadata(final byte[] imageData, final de.dpa.metadatamapper.imaging.common.ImageMetadata imageMetadata)
            throws Exception
    {
    ...
    public void writeMetadata(final InputStream inputStream, final de.dpa.metadatamapper.imaging.common.ImageMetadata imageMetadata,
