...
import de.dpa.metadatamapper.MetadataMapper;
...
public class ImageMetadataUtil
{
    ...
    public ImageMetadataUtil withIPTCMapping() throws JAXBException
    {
        InputStream mappingInputStream = ResourceUtil.resourceAsStream("/mapping/mapping-default.xml", MetadataMapper.class);
